...
const Linear = ({ color, strokeWidth }) => (
  <>
    <Path
      ...
      strokeLinejoin="round"
    ></Path>
    <Path d="M7.5 13.3h5.4" stroke={color} strokeWidth={strokeWidth} strokeMiterlimit="10"></Path>
    <Path
      d="M16.3 16v-5.3"
      stroke={color}
      strokeWidth={strokeWidth}
...
const Illustrator = forwardRef(({ variant, color, size, strokeWidth, ...rest }, ref) => {
  return (
    <Svg
      {...rest}
