...
const Broken = ({ color }) => (
  <>
    <Path d="M9.25 11h5.5" stroke={color} strokeWidth="{strokeWidth}" strokeLinecap="round"></Path>
    <Path
...
const LocationMinus = forwardRef(({ variant, color, size, strokeWidth, ...rest }, ref) => {
  return (
    <Svg
      {...rest}
